...
CORRECT_OPTION=true
PROJECT_TYPE_OPTIONS=~/.dotfiles/automation/generators/config-craft/options/project-type-options.txt
CONFIG_FILE_OPTIONS=~/.dotfiles/automation/generators/config-craft/options/config-files-options.txt
PROJECT_TYPE_SELECTED=''

PROJECT_TYPE_CONFIGS_DIR=~/.dotfiles/automation/generators/config-craft/project-type
